...
public class soundboardPageFour extends AppCompatActivity implements PopupDialog.popupDialogListener{
    ...
    public static Intent createIntent(Context context) {
        return new Intent(context, soundboardPageFour.class);
    }
