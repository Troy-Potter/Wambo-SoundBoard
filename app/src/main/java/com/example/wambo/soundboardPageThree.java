...
public class soundboardPageThree extends AppCompatActivity implements PopupDialog.popupDialogListener{
    ...
    public static Intent createIntent(Context context) {
        return new Intent(context, soundboardPageThree.class);
    }
